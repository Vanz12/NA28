...
nadya = LINETCR.LINE()
#nadya.login(qr=True)
nadya.login(token="Esecv41JDl5rw4pIdav8.eNDDiPwk1fdheMbDW5bLUa.eFHylgJZlF0Toiri8sMdlFrkIuP1uuVE/YJEYa/zUDc=")
#nadya.login(token = 'Eqf6v12kRjgo1HkPq9P9.Blt/u1CwtK89Oafel/+IYq.ucaU+tgnmAwhZdsdvimeOkd14Q/OZpK9haUCWhFIu/o=')
nadya.loginResult()
print "93 Company -Login Success\n\n=====[Sukses Login]====="
...
╚═════════════════════════
"""
tjia="u12775d22958ad450c712605dc39065b8"
...
╚═════════════════════════
"""
psn = """☆ҳ̸Ҳ̸ҳ ONGISNANDE - 87 BOT ҳ̸Ҳ̸ҳ☆
☆ ҳ̸Ҳ̸ҳ COSI FAMILY // GVMD FAMILY // FDC FAMILY ҳ̸Ҳ̸ҳ ☆
JASA :
AKTIVASI VIP 1TH⏩
1 VIP ANDROID 20K VIA PULSA/BANK
1-6 VIP ANDROID 100K
1 VIP I-PHONE : 300K VIA BANK

PEMBUATAN SONGBOOK 1-10 : 
100K VIA BANK

ROOM SIRI
JASA DESIGN
- Design Logo Official
- Design Cover Staff / Member
- Design Cover Event

☆ ҳ̸Ҳ̸ҳ ONGISNADE - 87 BOT ҳ̸Ҳ̸ҳ ☆"""
...
Bots=[mid]
Creator = ["u12775d22958ad450c712605dc39065b8"]
admin = ["u12775d22958ad450c712605dc39065b8"]
...
def download_page(url):
    ...
    if cur_version >= version:     
        ...
        try:
            headers = {}
            headers['User-Agent'] = "Mozilla/5.0 (Windows; U; Windows NT 5.2; en-US) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.89 Safari/537.36 UCBrowser/11.5.0.1015"
...
#                            Name = summon(op.param2)
        ...
        if op.type == 15:
          if wait["Sambutan"] == True:
            if op.param2 in Creator:
                return
            nadya.sendText(op.param1,"Leave ???.. Wafer yaa.. " + nadya.getContact(op.param2).displayName +  "\nSee You Next Time . . . Good Bye 🤗")
            d = Message(to=op.param1, from_=None, text=None, contentType=7)
            d.contentMetadata={
                                    "STKID": "16045178",
                                    "STKPKGID": "1418057",
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                    contact = nadya.getContact(msg.from_)
                    cName = contact.displayName
                    idstk = ["1428187","1418057","1456919"]
                    stvgid = random.choice(idstk)
                    name = re.findall(r'@(\w+)', msg.text)
                    mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                    mentionees = mention['MENTIONEES']
                    for mention in mentionees:
                           if mention['M'] in Bots:
                                  #nadya.sendText(msg.to,ret_)
                                  if stvgid =="1428187":
                                    stid =['16355914','16355915','16355916','16355917','16355918','16355919','16355921']
                                    stvid =random.choice(stid)         
                                    msg.text=None
                                    msg.contentType=7
                                    msg.contentMetadata={"STKID":stvid, "STKPKGID": stvgid,"STKVER": "1" }
                                    nadya.sendMessage(msg)   
                                  if stvgid =="1418057":
                                    stid =['16045178','16045179','16045180','16045181','16045182','16045183','16045184','16045185']
                                    stvid =random.choice(stid)         
                                    msg.text=None
                                    msg.contentType=7
                                    msg.contentMetadata={"STKID":stvid, "STKPKGID": stvgid,"STKVER": "1" }
                                    nadya.sendMessage(msg)   
                                  if stvgid =="1456919":
                                    stid =['17225906','17225907','17225908','17225909','17225910','17225911','17225913']
                                    stvid =random.choice(stid)         
                                    msg.text=None
                                    msg.contentType=7
                                    msg.contentMetadata={"STKID":stvid, "STKPKGID": stvgid,"STKVER": "1" }
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention2"] == True:          
                    contact = nadya.getContact(msg.from_)
                    cName = contact.displayName
                    sapa = ["hay ","halo ","pagi ","siang ","sorre ","malam ","hey ","assallamu'allaikum "]
                    anu = [" makan"," nyanyi"," anu"," meeting"," ngopi"," beli cabe"," duet mesla"," beli roti"]
                    tmpt = [" smule"," pojok"," rumah"," pasar"," mall"," kolong jembatan"]
                    btmp = random.choice(tmpt)
                    banu = random.choice(anu)
                    bsapa = random.choice(sapa)
                    balas = ["Kangen ya.. "+cName,"Klo Penting PC aja "+cName,"Maaf "+cName+" Lagi sibuk\nKlo udah gak sibuk aku kabarn "+cName,cName+" Kalo kangen von aja","Ngetag bayar "+cName,cName+" Aim lagi kojom di "+btmp+" \n" +cName,"klo PM yg Mesla "+cName,"nYimak ya..."+cName,"DON'T DISTRUB "+cName, cName+" Yes...."]                     
                    balas1 = [bsapa+cName,bsapa+cName+" ayo kita"+banu+"\n di "+btmp,cName+" makan yuk\n mumpung lagi di"+btmp,bsapa+cName+" aku lagi "+banu+" di "+btmp]
                    ret_ = random.choice(balas)
                    idstk = ["1428187","1418057","1456919","1621680"]
                    stvgid = random.choice(idstk)
                    name = re.findall(r'@(\w+)', msg.text)
                    mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                    mentionees = mention['MENTIONEES']
                    for mention in mentionees:
                           if mention['M'] in Bots:
                                  nadya.sendText(msg.to,ret_)
                                  if stvgid =="1621680":
                                    stid =['20837752','20837753','20837754','20837755','20837756','20837757','20837758','20837759','20837760','20837761','20837762','20837763','20837764','20837765','20837766','20837767','20837768','20837769','20837770','20837771','20837772','20837773','20837774','20837775']
                                    stvid =random.choice(stid)         
                                    msg.text=None
                                    msg.contentType=7
                                    msg.contentMetadata={"STKID":stvid, "STKPKGID": stvgid,"STKVER": "1" }
		...
		nadya.sendText(msg.to,"Itu Yang Buat Grup Ini")
            ...
            elif msg.text in ["Key creator","help creator","Help 1"]:
                nadya.sendText(msg.to,creatorMessage)

            elif msg.text in ["Key group","help group","Help 2"]:
                nadya.sendText(msg.to,groupMessage)

            elif msg.text in ["Key","help","Help"]:
                nadya.sendText(msg.to,helpMessage)

            elif msg.text in ["Key self","help self","Help 3"]:
                nadya.sendText(msg.to,selfMessage)

            elif msg.text in ["Key bot","help bot","Help 4"]:
                nadya.sendText(msg.to,botMessage)

            elif msg.text in ["Key set","help set","Help 5"]:
                nadya.sendText(msg.to,setMessage)

            elif msg.text in ["Key media","help media","Help 6"]:
                nadya.sendText(msg.to,mediaMessage)
                
            elif msg.text in ["Key admin","help admin","Help 7"]:
		...
		if wait["Simi"] == True: md+="╠➩✔️ Simisimi : On\n"
            ...
            elif msg.text.lower() in ["buset","aih","aish"]:
                msg.contentType = 7
                msg.contentMetadata={'STKID': '20980343',
                                    'STKPKGID': '1628288',
                                    'STKVER': '1'}
                msg.text = None
                nadya.sendMessage(msg)
                ...
                msg.text = None
                nadya.sendMessage(msg)
            elif msg.text.lower() in ["muach1"]:
                msg.contentType = 7
                msg.contentMetadata={'STKID': '15017202',
                                    'STKPKGID': '1384664',
                                    'STKVER': '1'}
                msg.text = None
                nadya.sendMessage(msg)
            elif msg.text.lower() in ["muach2"]:
                msg.contentType = 7
                msg.contentMetadata={'STKID': '1384664',
                                    'STKPKGID': '1384664',
                                    'STKVER': '100'}
                msg.text = None
                nadya.sendMessage(msg)
            elif msg.text.lower() in ["muach3"]:
                msg.contentType = 7
                msg.contentMetadata={'STKID': '15017210',
                                    'STKPKGID': '1384664',
                                    'STKVER': '1'}
                msg.text = None
                nadya.sendMessage(msg)
		...
		if midd not in admin:
		    ...
		    nadya.sendText(msg.to,"Admin Detected")
                ...
                midd = msg.text.replace("sl ","")
                gid = "c4ec49d47afecd4e049f00c2b1344eda8"
                nadya.findAndAddContactsByMid(midd)
                nadya.inviteIntoGroup(gid,[midd])
                ...
                msg.contentType = 7
                msg.contentMetadata={'STKID': '20837752',
                                    'STKPKGID': '1621680',
                                    'STKVER': '1'}
                msg.text = None
                nadya.sendMessage(msg)
	        ...
	        if msg.from_ in Creator:                
              ...
              if msg.from_ in Creator:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                nadya.sendImageWithURL(self,_to,'http://dl.profile.line-cdn.net/'+h.pictureStatus)
                                nadya.sendText(msg.to,"http://dl.profile.line-cdn.net/" + h.pictureStatus)
                                nadya.sendImage(msg.to,"http://dl.profile.line-cdn.net/" + h.pictureStatus)
                            except Exception as error:
                                print error
                                nadya.sendText(msg.to,"Upload image failed.")
                ...
                if txt[1] == "on":
                    ...
                    if jmlh <= 100000:
                        nadya.sendText(msg.to,jmlh +' Kali Spam '+teks)
                    else:
                        nadya.sendText(msg.to, "Out Of Range!")
		...
		if msg.from_ in Creator:
            ...
            elif "Youtubesrc " in msg.text:
                    query = msg.text.replace("Youtubesrc ","")
